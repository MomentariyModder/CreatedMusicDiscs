...
@Mod("created_music_discs")
public class CreatedMusicDiscsMod {
	public static final Logger LOGGER = LogManager.getLogger(CreatedMusicDiscsMod.class);
	public static final String MODID = "created_music_discs";

	public CreatedMusicDiscsMod() {
		MinecraftForge.EVENT_BUS.register(this);
		CreatedMusicDiscsModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		CreatedMusicDiscsModSounds.REGISTRY.register(bus);

		CreatedMusicDiscsModItems.REGISTRY.register(bus);
